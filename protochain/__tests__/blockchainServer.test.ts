...
describe('BlockchainServer Tests', () => {
    ...
    // test('POST /transactions/ - Should NOT add transaction (empty)', async () => {
    //     const tx = new Transaction();
    //     const response = await request(app)
    //         .post('/transactions/')
    //         .send(tx);
    ...
    // test('POST /transactions/ - Should NOT add transaction (invalid)', async () => {
    //     const tx = new Transaction({} as Transaction);
    //     const response = await request(app)
    //         .post('/transactions/')
    //         .send(tx);
